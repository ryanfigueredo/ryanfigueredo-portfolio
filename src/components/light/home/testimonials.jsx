        ...
        <div className="sec-head mb-80 wow fadeInUp">
          <div className="row">
            <div className="col-lg-7">
              <h6 className="sub-title opacity-7 mb-15">{testimonials.subtitle}</h6>
              <h3>
                {testimonials.title.split(" ")[0]} {" "}
                <span className="main-color">
                  {testimonials.title.split(" ").slice(1).join(" ")}
                </span>
              </h3>
            </div>
          </div>
                  ...
                  <SwiperSlide key={item.name}>
                    <div className="item">
                      <div className="icon-img-60 mr-60">
                        <img src="/light/assets/imgs/svg-assets/quote.png" alt="" />
                      </div>
                      ...
                      <div>
                        <div className="cont mb-30">
                          <div className="d-flex align-items-center">
                            <div className="rate-stars fz-12">
                              ...
                              <span className="fz-12 opacity-7 ml-10">(5.0)</span>
                            </div>
                          </div>
                        ...
                        <div className="d-flex align-items-center">
                          <div>
                            <div className="img">
                              <img src="/light/assets/imgs/testim/1.jpg" alt={item.name} />
                            </div>
                          </div>
                          <div className="ml-30">
                            <div className="info">
