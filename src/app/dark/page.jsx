...
export const metadata = {
  title: "Ryan Figueredo — Desenvolvedor Full-Stack",
  description:
    "Portfólio profissional de Ryan Figueredo, desenvolvedor full-stack especializado em soluções web com Next.js, Node.js e AWS.",
};
